<template>
    <div class="page-container"> <!-- 新增容器 -->
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                ...
                <div style="display: flex;width: 400px;">
                    <el-input v-model="name" placeholder="班级名"></el-input>
        ...
        <el-dialog title="添加" :visible.sync="dialogFormVisible" width="30%">
            <banji @close="handleClose" :key="dialogFormVisible" :form1="form" />
        </el-dialog>

    </div>
</template>
<script>
import banji from '@/components/admin/banji.vue'
import { classSearch, classFenye, classDel } from '@/api/classadmin'
export default {
    components: {
        banji
    },
    ...
    methods: {
        ...
        gettable() {
            ...
            this.fenyeZongshu()
            classSearch(data, this.page).then((result) => {
                // console.log(result);
